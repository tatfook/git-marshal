...
export default class FolderController extends Controller {
     ...
     * @param {String=} commitId get files of commitId
    ...
    public async files() {
        ...
        const { repoPath, folderPath, recursive, commitId, ref } = ctx.params;
        ctx.body = await ctx.service.folder.getFiles(repoPath, folderPath, recursive, commitId, ref);
    }
